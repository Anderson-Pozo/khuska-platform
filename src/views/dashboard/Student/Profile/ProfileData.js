            ...
            <Grid container>
              <Grid item xs={6}>
                <FormControl fullWidth sx={{ ...theme.typography.customInput, padding: 0.2, paddingRight: 1 }}>
                  <InputLabel htmlFor="outlined-adornment-name-register">Nombre Completo</InputLabel>
                  <OutlinedInput
              ...
              <Grid item xs={6}>
                <FormControl fullWidth sx={{ ...theme.typography.customInput, padding: 0.2, paddingLeft: 0.5 }}>
