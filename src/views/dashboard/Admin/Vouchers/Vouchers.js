...
import { IconCheck, IconCircleX, IconDownload, IconEdit, IconFile, IconTicket, IconTrash } from '@tabler/icons';
      ...
      <AppBar position="static" style={uiStyles.appbar}>
        <Container maxWidth="xl" style={uiStyles.container}>
          <Toolbar disableGutters>
            <IconTicket color="#FFF" style={{ marginLeft: 0, marginRight: 20 }} />
          </Toolbar>
        </Container>
      </AppBar>
      <Box sx={{ flexGrow: 0 }}>
